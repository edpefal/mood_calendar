...
El launch screen en iOS y Android SHALL mostrar un fondo de color `#5F3DC4` (púrpura principal de la app) a pantalla completa, con el icono de la app centrado horizontal y verticalmente.

#### Scenario: Launch screen en iOS
- **WHEN** el usuario abre la app en un dispositivo iOS
- **THEN** aparece una pantalla de fondo púrpura `#5F3DC4` con el icono de la app centrado antes de que cargue la UI principal
